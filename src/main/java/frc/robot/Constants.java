...
public final class Constants {
  ...
  public static final class Elevator {
    ...
    /** Default height used when intaking a coral. */
    public static final double intakeSetpoint =
        ElevatorManipulatorPositions.kElevatorIntake;
  }
  ...
  public static final class DifferentialArm {
    ...
    /** Extension commanded when gathering a coral. */
    public static final double intakeExtensionSetpoint =
        ElevatorManipulatorPositions.kExtensionIntake;
    /** Rotation commanded when gathering a coral. */
    public static final double intakeRotationSetpoint =
        ElevatorManipulatorPositions.kRotationIntake;
    /** Extension commanded when the manipulator travels safely. */
    public static final double transportExtensionSetpoint =
        ElevatorManipulatorPositions.kExtensionTransport;
    /** Rotation commanded when the manipulator travels safely. */
    public static final double transportRotationSetpoint =
        ElevatorManipulatorPositions.kRotationTransport;
  }
