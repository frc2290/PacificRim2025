...
public class ManipulatorStateMachine extends SubsystemBase {
  ...
  private void initializeGraphCommand() {
    ...
    prepAlgaeL2Node =
        m_graphCommand
        .new GraphCommandNode(
            "PrepAlgaeL2", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    prepAlgaeL3Node =
        m_graphCommand
        .new GraphCommandNode(
            "PrepAlgaeL3", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    safeAlgaeTravelNode =
        m_graphCommand
        .new GraphCommandNode(
            "SafeAlgaeTravelPos", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    scoreProssesorNode =
        m_graphCommand
        .new GraphCommandNode(
            "ScoreProcessor", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    prepScoreBargeNode =
        m_graphCommand
        .new GraphCommandNode(
            "PrepScoreBarge", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    scoreBargeNode =
        m_graphCommand
        .new GraphCommandNode(
            "ScoreBarge", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    climbPrepNode =
        m_graphCommand
        .new GraphCommandNode(
            "ClimbPrep", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));

    climbReadyNode =
        m_graphCommand
        .new GraphCommandNode(
            "ClimbReady", new PrintCommand(""), new PrintCommand(""), new PrintCommand(""));
  ...
  public ElevatorManipulatorState getCurrentState() {
    ...
    if (currentNode == climbPrepNode || currentNode == climbReadyNode)
