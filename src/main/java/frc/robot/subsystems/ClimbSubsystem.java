...
public class ClimbSubsystem extends SubsystemBase {
  ...
  public ClimbSubsystem() {
    ...
    if (RobotBase.isSimulation()) {
      ...
      double deployMOI =
          SingleJointedArmSim.estimateMOI(Climber.kSimArmLengthMeters, Climber.kSimDeployMassKg);
      double retractMOI =
          SingleJointedArmSim.estimateMOI(Climber.kSimArmLengthMeters, Climber.kSimRetractMassKg);
