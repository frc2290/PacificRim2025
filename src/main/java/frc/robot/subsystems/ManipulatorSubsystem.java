...
public class ManipulatorSubsystem extends SubsystemBase {
  ...
  public ManipulatorSubsystem() {
    ...
    if (RobotBase.isSimulation()) {
      ...
      motorModel = new DCMotorSim(LinearSystemId.createDCMotorSystem(gearbox, 0.001, 1.0), gearbox);
    }
  ...
  /**
   * Test-oriented constructor allowing hardware dependencies to be supplied externally for unit
   * testing.
   */
  public ManipulatorSubsystem(
