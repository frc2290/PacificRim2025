...
public class Right1Coral extends SequentialCommandGroup {
    ...
    public Right1Coral(PoseEstimatorSubsystem poseEst, StateSubsystem stateSubsystem, ManipulatorSubsystem manipulator) {
        try {
            ...
            addCommands(resetPose, driveSetAuto, moveToReef, new ScoreCoral(manipulator, stateSubsystem, poseEst), driveSetTeleop);
        } catch (Exception e) {
