...
public final class ManipulatorPositionCommandFactory {
    ...
    /**
     * Creates a command that drives the elevator and differential arm to the supplied setpoints
     * and marks the manipulator state machine as ready once the position is reached.
     */
    ...
    /**
     * Creates a command that drives the manipulator to the supplied setpoints sequentially in a
     * safe deploy order (extension, rotation, then elevator) without marking the manipulator as
     * ready when finished.
     */
    ...
    /**
     * Creates a command that drives the manipulator to the supplied setpoints sequentially in a
     * safe return order (elevator, rotation, then extension) without marking the manipulator as
     * ready when finished.
     */
