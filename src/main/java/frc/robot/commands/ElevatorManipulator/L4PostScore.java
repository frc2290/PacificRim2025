...
public class L4PostScore extends Command{
    ...
    public L4PostScore(ManipulatorStateMachine m_state, DifferentialSubsystem m_diff, ElevatorSubsystem m_elevator){
    ...
    public void initialize() {
        System.out.println("L4Post Initializing");
    ...
    public void execute(){
        ...
        if(diffArm.atRotationSetpoint() && elevator.atPosition() && diffArm.atExtenstionSetpoint()){
            atPosition = true;
            System.out.println("L4Post Done");
        }
