...
public class AlgaeRemoval extends Command {
    ...
    public AlgaeRemoval(ManipulatorSubsystem m_manip, ArmStateManager arm, DriveStateManager drive, boolean _level2) {
        manip = m_manip;
        this.arm = arm;
        this.drive = drive;
        level2 = _level2;
    ...
    public void initialize() {
        arm.setElevManiGoal(ElevatorManipulatorState.AlgaeL2);
