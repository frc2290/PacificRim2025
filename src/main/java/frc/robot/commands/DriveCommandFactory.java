...
public class DriveCommandFactory extends Command {
    ...
    public DriveCommandFactory(
        ...
        drive = Objects.requireNonNull(m_drive);
        poseEstimator = Objects.requireNonNull(m_poseEstimator);
        driverController = Objects.requireNonNull(m_driverController);
