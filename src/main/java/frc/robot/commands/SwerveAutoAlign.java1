  ...
  public void initialize() {
    ...
    List<Waypoint> waypoints =
        PathPlannerPath.waypointsFromPoses(
            new Pose2d(
                pose.getCurrentPose().getTranslation(),
                getPathVelocityHeading(pose.getChassisSpeeds(), nearestBranch)),
            nearestBranch);
    ...
    PathPlannerPath path =
        new PathPlannerPath(
            ...
            new IdealStartingState(
                getVelocityMagnitude(pose.getChassisSpeeds()), pose.getCurrentRotation()),
