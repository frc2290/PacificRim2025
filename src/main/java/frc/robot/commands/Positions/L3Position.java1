...
public class L3Position extends SequentialCommandGroup {
  private double elevatorPos = 1.14;
  private double diffExt = 80;
  private double diffRot = 230;
  ...
  public L3Position(
    ...
    if (stateSubsystem.getCurrentState() == PositionState.StartPosition) {
      ...
      addCommands(
          moveExtTransport,
          elevAndRot,
          stateSubsystem.setCurrentStateCommand(PositionState.L3Position));
    } /*
       ...
       * ParallelCommandGroup moveAndUp = new ParallelCommandGroup(moveExtStep1,
       * moveElevator);
       ...
       * ParallelCommandGroup rotateAndUpRest = new ParallelCommandGroup(moveRotStep2,
       * moveElev2);
       * Command moveRot = diffArm.setRotationSetpointCommand(diffRot);
      ...
      addCommands(
          moveExtAndElev, moveRot, stateSubsystem.setCurrentStateCommand(PositionState.L3Position));
    }
  }
}
