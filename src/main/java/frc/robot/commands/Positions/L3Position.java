...
public class L3Position extends Command {
    private double elevatorPos = 1.0;
    ...
    public L3Position(DifferentialSubsystem m_diff, ElevatorSubsystem m_elevator, DriveSubsystem m_drive, StateSubsystem m_state) {
        elevator = m_elevator;
        diff = m_diff;
        state = m_state;
        drive = m_drive;
