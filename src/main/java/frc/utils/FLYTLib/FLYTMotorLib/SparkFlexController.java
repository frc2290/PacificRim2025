...
public class SparkFlexController extends FlytMotorController {
  ...
  /**
   * Run this constructor for brushed and brushless motors with no connected external encoders. You
   * are required to run encoderCfg() if brushless is chosen.
   *
   ...
   */
  public SparkFlexController(
      String m_motorName, int m_id, boolean m_brushless, boolean m_break, boolean invert) {
    super(m_motorName);
  ...
  public void set(double set) {
    ...
    if (ControlType.kCurrent == controlType
        || ControlType.kDutyCycle == controlType
        || ControlType.kVoltage == controlType) {
