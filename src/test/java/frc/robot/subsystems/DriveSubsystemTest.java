...
class DriveSubsystemTest {
    ...
    @BeforeEach
    void setUp() {
        drive = new DriveSubsystem(frontLeft, frontRight, rearLeft, rearRight, gyro);
    }
    ...
    void driveSetsModuleStates() {
        ...
        SwerveModuleState[] expected = DriveConstants.kDriveKinematics
                .toSwerveModuleStates(new ChassisSpeeds(DriveConstants.kMaxSpeedMetersPerSecond, 0.0, 0.0));
    ...
    void setXStopsModules() {
        ...
        assertStateEquals(new SwerveModuleState(0.0, Rotation2d.fromDegrees(45)), flCaptor.getValue());
        assertStateEquals(new SwerveModuleState(0.0, Rotation2d.fromDegrees(-45)), frCaptor.getValue());
        assertStateEquals(new SwerveModuleState(0.0, Rotation2d.fromDegrees(-45)), rlCaptor.getValue());
        assertStateEquals(new SwerveModuleState(0.0, Rotation2d.fromDegrees(45)), rrCaptor.getValue());
    }
