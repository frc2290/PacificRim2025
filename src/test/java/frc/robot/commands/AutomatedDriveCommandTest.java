  ...
  void usesControllerInputsWhenRotating() {
    ...
    double expectedX =
        -edu.wpi.first.math.MathUtil.applyDeadband(
            0.2, frc.robot.Constants.OIConstants.kDriveDeadband);
    double expectedY =
        -edu.wpi.first.math.MathUtil.applyDeadband(
            0.1, frc.robot.Constants.OIConstants.kDriveDeadband);
    double expectedR =
        -edu.wpi.first.math.MathUtil.applyDeadband(
            0.3, frc.robot.Constants.OIConstants.kDriveDeadband);
